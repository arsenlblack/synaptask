...
- **publicDue**: optional UTC timestamp (ISO 8601, `...Z`)
- **phantom**: boolean — whether node with no access connected with primary link
...
See also: [Links](./links) and [History](./history).
